...
export const products: Product[] = [
  {
    ...
    usageInstructions:
      "Zaparz jako wieczorny napar lub użyj w dowolnym urządzeniu aromatyzującym. Kubek, koc, cisza - dobranoc.",
  },
  {
    id: "sleep-terpene",
    name: "Sleep",
    ...
    usageInstructions:
      "Zaparz jako wieczorny napar lub użyj w dowolnym urządzeniu aromatyzującym. Na spokojną noc, na pełen reset.",
  },
  {
    id: "chill",
    name: "Chill",
    ...
    usageInstructions:
      "Zaparz jako napar lub użyj w dowolnym urządzeniu aromatyzującym. Na kanapie, na balkonie, ze znajomymi.",
  },
  {
    id: "chill-terpene",
    name: "Chill",
    ...
    usageInstructions:
      "Zaparz jako napar lub użyj w dowolnym urządzeniu aromatyzującym. Leniwy wieczór, twórcza sesja, spotkanie na luzie.",
  },
  {
    id: "focus",
    name: "Focus",
    ...
    usageInstructions:
      "Zaparz jako napar lub użyj w dowolnym urządzeniu aromatyzującym. Poranna sesja, deep work, deadline.",
  },
  {
    id: "focus-terpene",
    name: "Focus",
    ...
    usageInstructions:
      "Zaparz jako napar lub użyj w dowolnym urządzeniu aromatyzującym. Poranny rozruch, deadline, maraton kreatywny.",
  },
  {
    id: "fresh",
    name: "Fresh",
    ...
    usageInstructions:
      "Zaparz jako napar lub użyj w dowolnym urządzeniu aromatyzującym. Rano, po treningu, w środku dnia - kiedy potrzebujesz resetu.",
  },
  {
    id: "discovery-pack",
    ...
    usageInstructions:
      "Każda saszetka to herbata ziołowa lub mieszanka do aromatyzacji. Dobierz do nastroju - rano, wieczorem, ze znajomymi.",
  },
];
